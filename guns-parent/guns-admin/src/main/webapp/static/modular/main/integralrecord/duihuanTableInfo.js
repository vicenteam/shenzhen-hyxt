...
Integralrecord.initColumn = function () {
    return [
        {field: 'selectItem', radio: true,visible: false,},
            ...
            {title: '商品兑换量', field: 'num', visible: true, align: 'center', valign: 'middle',sortable: true},
...
$(function () {
    ...
    var table = new BSTable(Integralrecord.id, "/integralrecord/duihuanTableData", defaultColunms);
    //table.setPaginationType("client");
    table.setPaginationType("server");
    table.setQueryParams({deptId:$("#deptId").val(),status:$("#status").val()})
    Integralrecord.table = table.init();
});
Integralrecord.dataexport=function () {
    window.location.href = Feng.ctxPath + "/integralrecord/dataexport2?limit=9999999&offset=0&"+
        "deptId=" + $("#deptId").val() +
